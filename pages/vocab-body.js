...
const WORDS = [
  ...
  { num:2,  en:'mouth',         vi:'miệng',            s:'A', x:16,   y:10  },
  { num:3,  en:'chin',          vi:'cằm',              s:'A', x:16,   y:12  },
  { num:4,  en:'neck',          vi:'cổ',               s:'A', x:17,   y:14  },
  { num:5,  en:'shoulder',      vi:'vai',              s:'A', x:21,   y:17  },
  { num:6,  en:'arm',           vi:'cánh tay',         s:'A', x:8,    y:28  },
  { num:7,  en:'upper arm',     vi:'cánh tay trên',    s:'A', x:21,   y:22  },
  { num:8,  en:'elbow',         vi:'khuỷu tay',        s:'A', x:23,   y:30  },
  { num:9,  en:'forearm',       vi:'cẳng tay',         s:'A', x:25,   y:36  },
  { num:10, en:'armpit',        vi:'nách',             s:'A', x:20,   y:23  },
  { num:11, en:'back',          vi:'lưng',             s:'A', x:13,   y:28  },
  { num:12, en:'chest',         vi:'ngực',             s:'A', x:19,   y:25  },
  { num:13, en:'waist',         vi:'eo',               s:'A', x:21,   y:36  },
  { num:14, en:'abdomen',       vi:'bụng',             s:'A', x:19,   y:39  },
  { num:15, en:'buttocks',      vi:'mông',             s:'A', x:15,   y:45  },
  { num:16, en:'hip',           vi:'hông',             s:'A', x:22,   y:43  },
  { num:17, en:'leg',           vi:'chân',             s:'A', x:28,   y:57  },
  { num:18, en:'thigh',         vi:'đùi',              s:'A', x:20,   y:51  },
  { num:19, en:'knee',          vi:'đầu gối',          s:'A', x:20,   y:59  },
  { num:20, en:'calf',          vi:'bắp chân',         s:'A', x:20,   y:67  },
  // B – The Hand
  { num:21, en:'wrist',         vi:'cổ tay',           s:'B', x:39,   y:22  },
  { num:22, en:'knuckle',       vi:'đốt ngón tay',     s:'B', x:44,   y:13  },
  { num:23, en:'fingernail',    vi:'móng tay',         s:'B', x:49,   y:7   },
  { num:24, en:'thumb',         vi:'ngón cái',         s:'B', x:37,   y:12  },
  { num:25, en:'index finger',  vi:'ngón trỏ',         s:'B', x:57,   y:9   },
  { num:26, en:'middle finger', vi:'ngón giữa',        s:'B', x:61,   y:7   },
  { num:27, en:'ring finger',   vi:'ngón đeo nhẫn',    s:'B', x:64,   y:9   },
  { num:28, en:'little finger', vi:'ngón út',          s:'B', x:67,   y:11  },
  { num:29, en:'palm',          vi:'lòng bàn tay',     s:'B', x:62,   y:21  },
  // C – The Head
  { num:30, en:'hair',          vi:'tóc',              s:'C', x:50,   y:37  },
  { num:31, en:'part',          vi:'ngôi tóc',         s:'C', x:53,   y:36  },
  { num:32, en:'forehead',      vi:'trán',             s:'C', x:58,   y:40  },
  { num:33, en:'sideburn',      vi:'râu má',           s:'C', x:48,   y:47  },
  { num:34, en:'ear',           vi:'tai',              s:'C', x:46,   y:51  },
  { num:35, en:'cheek',         vi:'má',               s:'C', x:54,   y:51  },
  { num:36, en:'nose',          vi:'mũi',              s:'C', x:57,   y:49  },
  { num:37, en:'nostril',       vi:'lỗ mũi',          s:'C', x:61,   y:52  },
  { num:38, en:'jaw',           vi:'hàm',              s:'C', x:49,   y:59  },
  { num:39, en:'beard',         vi:'râu',              s:'C', x:55,   y:57  },
  { num:40, en:'mustache',      vi:'ria mép',          s:'C', x:56,   y:55  },
  { num:41, en:'tongue',        vi:'lưỡi',             s:'C', x:58,   y:59  },
  { num:42, en:'tooth',         vi:'răng',             s:'C', x:61,   y:59  },
  { num:43, en:'lip',           vi:'môi',              s:'C', x:63,   y:57  },
  // D – The Eye
  { num:44, en:'eyebrow',       vi:'lông mày',         s:'D', x:79,   y:38  },
  { num:45, en:'eyelid',        vi:'mí mắt',           s:'D', x:81,   y:42  },
  { num:46, en:'eyelashes',     vi:'lông mi',          s:'D', x:77,   y:44  },
  { num:47, en:'iris',          vi:'tròng mắt',        s:'D', x:78.5, y:44.5},
  { num:48, en:'pupil',         vi:'con ngươi',        s:'D', x:79,   y:46  },
]
